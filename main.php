...
<!--cards and widgets above here-->
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>,Developed&nbsp;<i class="ti-heart heart"></i> &nbsp;By: Nashon Kimutai <a href="http://kimutainashon.000webhostapp.com/">Kimutainashon-Freelancing site</a>
                </div>
            </div>
        </footer>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'ti-gift',
            	message: "Welcome to <b>Shamma Primary School Management System admin</b> - a beautiful system for managing our school."
